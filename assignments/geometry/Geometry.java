...
public class Geometry {
  ...
  public double totalSurfaceAreaOfConeFromSlantHeight(double radius, double slant height){
    return curvedSurfaceAreaOfConeFromSlantHeight(radius, height)+areaOfCircle(radius);
  }
}
